...
#define updateLabelHeight (isIpad ? 140 : 70)
        
#define commentCountLabelY (isIpad ? 190 : 95)
...
#define dateLabelSpeator (isIpad ? 10 : 5)
        ...
        _dateLabel.frame = CGRectMake(_likeCountLabel.frame.origin.x + _likeCountLabel.frame.size.width + dateLabelSpeator - 32, _commentCountLabel.frame.origin.y, _commentCountLabel.frame.size.width+32, _commentCountLabel.frame.size.height);
